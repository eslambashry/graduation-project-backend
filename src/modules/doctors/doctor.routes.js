...
import { createDoctor, deleteDoctor, getAllDoctors, getDoctorById, getDoctorsWithAppointments, login, updateDoctor, updateDoctorAvailableDate } from './doctor.controller.js';
